...
export function SitemarkIcon() {
  return (
    <SvgIcon sx={{ height: 40, width: 150, mr: 2 }}>
      <svg
        width="200"
        height="50"
        viewBox="0 0 200 50"
      ...
      >
        {/* <!-- Square container --> */}
        <rect x="0" y="0" width="40" height="40" fill="none" stroke="#4876EF" strokeWidth="2" rx="4"/>

        {/* <!-- Three vertical bars inside the square --> */}
        <rect x="8" y="20" width="4" height="12" fill="#DC143C" />
        <rect x="16" y="16" width="4" height="16" fill="#20B2AA" />
        <rect x="24" y="10" width="4" height="22" fill="#FFD700" />

        {/* <!-- Brand name --> */}
        <text x="50" y="35" fontFamily="sans-serif" fontSize="30" fontWeight="bold" fill="#4876EF">
          Optimus
        </text>
      </svg>
    </SvgIcon>
